...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-authorization/security/advisories/new).
...
- **Email** — `support@semitexa.com`. Put "security" and the package name
  (`semitexa/authorization`) in the subject.
...
In scope: anything in `semitexa/authorization` that lets a request, a job or a message do
